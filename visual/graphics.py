...
class OrbitalGraphics:
    def __setup_objects(self):
        self.sun.transform = STTransform(translate=[0, 0, 0])
    ...
    def __init__(self):
        ...
        self.sun = scene.visuals.Sphere(radius=20, method='latitude', parent=self.view.scene,
                                        edge_color='white')

        self.earth = scene.visuals.Sphere(radius=1, method='latitude', parent=self.view.scene,
                                          edge_color='white')
